package Interview.Thread.LockMechanisms;
...
public class CyclicBarrierDemo {
    ...
    public static void main(String[] args) {
        ...
        // Interview.Thread-lərin yaradılması və başlaması
        Thread t1 = new Thread(task, "Interview.Thread-1");
        Thread t2 = new Thread(task, "Interview.Thread-2");
        Thread t3 = new Thread(task, "Interview.Thread-3");
