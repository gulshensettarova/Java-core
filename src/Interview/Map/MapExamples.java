...
public class MapExamples {
    public static void main(String[] args) {
        ...
        // 4. containsKey(Object key) - Açarın Interview.Map-də Olub-Olmadığını Yoxlamaq
        boolean hasKeyBob = map.containsKey("Bob");
        System.out.println("Contains 'Bob': " + hasKeyBob); // Output: Contains 'Bob': true

        // 5. containsValue(Object value) - Dəyərin Interview.Map-də Olub-Olmadığını Yoxlamaq
        ...
        // 9. keySet() - Interview.Map-dəki Açarları Almaq
        map.put("Alice", 25);
        map.put("Bob", 30);
        Set<String> keys = map.keySet();
        System.out.println("Keys: " + keys); // Output: Keys: [Alice, Bob]

        // 10. values() - Interview.Map-dəki Dəyərləri Almaq
        Collection<Integer> values = map.values();
        System.out.println("Values: " + values); // Output: Values: [25, 30]

        // 11. entrySet() - Interview.Map-dəki Açar-Dəyər Cütlərini Almaq
        ...
        // 12. putAll(Interview.Map<? extends K, ? extends V> m) - Başqa Interview.Map-dəki Açar-Dəyər Cütlərini İndiki Interview.Map-ə Əlavə Etmək
        ...
        // 15. computeIfAbsent(K key, Function<? super K, ? extends V> mappingFunction) - Əgər Açar Interview.Map-də Mövcud Deyilsə, Dəyəri Hesablayıb Əlavə Etmək
